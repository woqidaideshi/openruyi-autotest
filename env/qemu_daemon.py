...
class QemuVMManager:
    ...
    def setup(self) -> bool:
        ...
        # 写入国内镜像的 openEuler 源（华为云）
        self._ssh.exec(
            f"cat > /etc/yum.repos.d/openEuler-mirror.repo << 'EOF'\n"
            f"[OS]\n"
            f"name=OS\n"
            f"baseurl=https://mirrors.huaweicloud.com/openeuler/openEuler-24.03-LTS-SP2/OS/$basearch/\n"
            f"enabled=1\n"
            f"gpgcheck=0\n"
            f"\n"
            f"[everything]\n"
            f"name=everything\n"
            f"baseurl=https://mirrors.huaweicloud.com/openeuler/openEuler-24.03-LTS-SP2/everything/$basearch/\n"
            f"enabled=1\n"
            f"gpgcheck=0\n"
            f"\n"
            f"[EPOL]\n"
            f"name=EPOL\n"
            f"baseurl=https://mirrors.huaweicloud.com/openeuler/openEuler-24.03-LTS-SP2/EPOL/main/$basearch/\n"
            f"enabled=1\n"
            f"gpgcheck=0\n"
            f"\n"
            f"[update]\n"
            f"name=update\n"
            f"baseurl=https://mirrors.huaweicloud.com/openeuler/openEuler-24.03-LTS-SP2/update/$basearch/\n"
            f"enabled=1\n"
            f"gpgcheck=0\n"
            f"EOF"
        )
