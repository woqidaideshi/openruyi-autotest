#!/bin/bash
# Functional test: ltp - containers - userns07
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP containers - userns07"
        rlRun "kirk -f containers -p userns07 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP userns07"
