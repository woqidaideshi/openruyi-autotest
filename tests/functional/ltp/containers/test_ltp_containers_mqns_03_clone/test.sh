#!/bin/bash
# Functional test: ltp - containers - mqns_03_clone
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP containers - mqns_03_clone"
        rlRun "kirk -f containers -p mqns_03_clone 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mqns_03_clone"
