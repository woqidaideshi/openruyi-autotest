#!/bin/bash
# Functional test: ltp - containers - mqns_02_clone
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP containers - mqns_02_clone"
        rlRun "kirk -f containers -p mqns_02_clone 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mqns_02_clone"
