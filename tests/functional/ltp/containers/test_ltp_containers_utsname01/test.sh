#!/bin/bash
# Functional test: ltp - containers - utsname01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP containers - utsname01"
        rlRun "kirk -f containers -p utsname01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP utsname01"
