#!/bin/bash
# Functional test: ltp - containers - timerfd04
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP containers - timerfd04"
        rlRun "kirk -f containers -p timerfd04 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP timerfd04"
