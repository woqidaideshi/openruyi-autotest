#!/bin/bash
# Functional test: ltp - containers - utsname02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP containers - utsname02"
        rlRun "kirk -f containers -p utsname02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP utsname02"
