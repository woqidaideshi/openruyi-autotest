#!/bin/bash
# Functional test: ltp - commands - lsmod01_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - lsmod01_sh"
        rlRun "kirk -f commands -p lsmod01_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP lsmod01_sh"
