#!/bin/bash
# Functional test: ltp - commands - ar_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - ar_sh"
        rlRun "kirk -f commands -p ar_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP ar_sh"
