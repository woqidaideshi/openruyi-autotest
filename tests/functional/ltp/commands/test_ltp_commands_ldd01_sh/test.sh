#!/bin/bash
# Functional test: ltp - commands - ldd01_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - ldd01_sh"
        rlRun "kirk -f commands -p ldd01_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP ldd01_sh"
