#!/bin/bash
# Functional test: ltp - commands - du01_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - du01_sh"
        rlRun "kirk -f commands -p du01_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP du01_sh"
