#!/bin/bash
# Functional test: ltp - commands - sysctl02_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - sysctl02_sh"
        rlRun "kirk -f commands -p sysctl02_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP sysctl02_sh"
