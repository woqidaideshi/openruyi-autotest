#!/bin/bash
# Functional test: ltp - commands - nm01_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - nm01_sh"
        rlRun "kirk -f commands -p nm01_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP nm01_sh"
