#!/bin/bash
# Functional test: ltp - commands - ln01_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - ln01_sh"
        rlRun "kirk -f commands -p ln01_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP ln01_sh"
