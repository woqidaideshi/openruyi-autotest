#!/bin/bash
# Functional test: ltp - commands - file01_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - file01_sh"
        rlRun "kirk -f commands -p file01_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP file01_sh"
