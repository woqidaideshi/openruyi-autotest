#!/bin/bash
# Functional test: ltp - commands - gdb01_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - gdb01_sh"
        rlRun "kirk -f commands -p gdb01_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP gdb01_sh"
