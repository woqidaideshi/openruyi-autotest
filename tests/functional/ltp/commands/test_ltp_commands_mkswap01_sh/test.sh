#!/bin/bash
# Functional test: ltp - commands - mkswap01_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - mkswap01_sh"
        rlRun "kirk -f commands -p mkswap01_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mkswap01_sh"
