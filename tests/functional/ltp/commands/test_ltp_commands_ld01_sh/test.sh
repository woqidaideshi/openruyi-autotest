#!/bin/bash
# Functional test: ltp - commands - ld01_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - ld01_sh"
        rlRun "kirk -f commands -p ld01_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP ld01_sh"
