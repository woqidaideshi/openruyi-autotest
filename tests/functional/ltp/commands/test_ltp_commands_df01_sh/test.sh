#!/bin/bash
# Functional test: ltp - commands - df01_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - df01_sh"
        rlRun "kirk -f commands -p df01_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP df01_sh"
