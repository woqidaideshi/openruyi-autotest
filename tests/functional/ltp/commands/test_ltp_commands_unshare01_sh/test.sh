#!/bin/bash
# Functional test: ltp - commands - unshare01_sh
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP commands - unshare01_sh"
        rlRun "kirk -f commands -p unshare01_sh 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP unshare01_sh"
