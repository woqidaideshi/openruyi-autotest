#!/bin/bash
# Functional test: ltp - input - input03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP input - input03"
        rlRun "kirk -f input -p input03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP input03"
