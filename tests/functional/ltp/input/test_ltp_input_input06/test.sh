#!/bin/bash
# Functional test: ltp - input - input06
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP input - input06"
        rlRun "kirk -f input -p input06 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP input06"
