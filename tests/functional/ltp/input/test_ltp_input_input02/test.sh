#!/bin/bash
# Functional test: ltp - input - input02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP input - input02"
        rlRun "kirk -f input -p input02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP input02"
