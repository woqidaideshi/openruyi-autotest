#!/bin/bash
# Functional test: ltp - input - input04
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP input - input04"
        rlRun "kirk -f input -p input04 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP input04"
