#!/bin/bash
# Functional test: ltp - crypto - af_alg08
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP crypto - af_alg08"
        rlRun "kirk -f crypto -p af_alg08 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP af_alg08"
