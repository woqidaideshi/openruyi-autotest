#!/bin/bash
# Functional test: ltp - crypto - af_alg07
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP crypto - af_alg07"
        rlRun "kirk -f crypto -p af_alg07 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP af_alg07"
