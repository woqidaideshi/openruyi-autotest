#!/bin/bash
# Functional test: ltp - math - fptest01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP math - fptest01"
        rlRun "kirk -f math -p fptest01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fptest01"
