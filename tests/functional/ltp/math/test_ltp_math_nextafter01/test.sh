#!/bin/bash
# Functional test: ltp - math - nextafter01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP math - nextafter01"
        rlRun "kirk -f math -p nextafter01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP nextafter01"
