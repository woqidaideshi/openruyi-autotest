#!/bin/bash
# Functional test: ltp - tracing - dynamic_debug01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP tracing - dynamic_debug01"
        rlRun "kirk -f tracing -p dynamic_debug01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP dynamic_debug01"
