#!/bin/bash
# Functional test: ltp - tracing - fanotify25
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP tracing - fanotify25"
        rlRun "kirk -f tracing -p fanotify25 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fanotify25"
