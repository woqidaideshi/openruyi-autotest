#!/bin/bash
# Functional test: ltp - kernel_misc - tpci
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP kernel_misc - tpci"
        rlRun "kirk -f kernel_misc -p tpci 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP tpci"
