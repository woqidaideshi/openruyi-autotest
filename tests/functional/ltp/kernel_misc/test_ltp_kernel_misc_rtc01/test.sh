#!/bin/bash
# Functional test: ltp - kernel_misc - rtc01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP kernel_misc - rtc01"
        rlRun "kirk -f kernel_misc -p rtc01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP rtc01"
