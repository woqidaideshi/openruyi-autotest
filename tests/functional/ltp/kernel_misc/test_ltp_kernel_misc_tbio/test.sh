#!/bin/bash
# Functional test: ltp - kernel_misc - tbio
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP kernel_misc - tbio"
        rlRun "kirk -f kernel_misc -p tbio 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP tbio"
