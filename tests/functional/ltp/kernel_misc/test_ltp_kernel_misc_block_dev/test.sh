#!/bin/bash
# Functional test: ltp - kernel_misc - block_dev
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP kernel_misc - block_dev"
        rlRun "kirk -f kernel_misc -p block_dev 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP block_dev"
