#!/bin/bash
# Functional test: ltp - kernel_misc - uaccess
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP kernel_misc - uaccess"
        rlRun "kirk -f kernel_misc -p uaccess 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP uaccess"
