#!/bin/bash
# Functional test: ltp - kernel_misc - rtc02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP kernel_misc - rtc02"
        rlRun "kirk -f kernel_misc -p rtc02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP rtc02"
