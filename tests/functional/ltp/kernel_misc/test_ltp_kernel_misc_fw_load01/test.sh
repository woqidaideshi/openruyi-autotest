#!/bin/bash
# Functional test: ltp - kernel_misc - fw_load01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP kernel_misc - fw_load01"
        rlRun "kirk -f kernel_misc -p fw_load01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fw_load01"
