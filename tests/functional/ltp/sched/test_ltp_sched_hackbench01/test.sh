#!/bin/bash
# Functional test: ltp - sched - hackbench01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP sched - hackbench01"
        rlRun "kirk -f sched -p hackbench01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hackbench01"
