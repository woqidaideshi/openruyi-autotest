#!/bin/bash
# Functional test: ltp - sched - proc_sched_rt01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP sched - proc_sched_rt01"
        rlRun "kirk -f sched -p proc_sched_rt01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP proc_sched_rt01"
