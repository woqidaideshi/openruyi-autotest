#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap24
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap24"
        rlRun "kirk -f hugetlb -p hugemmap24 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap24"
