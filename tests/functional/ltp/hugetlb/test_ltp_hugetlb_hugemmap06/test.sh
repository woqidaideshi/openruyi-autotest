#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap06
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap06"
        rlRun "kirk -f hugetlb -p hugemmap06 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap06"
