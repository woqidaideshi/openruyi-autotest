#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap15
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap15"
        rlRun "kirk -f hugetlb -p hugemmap15 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap15"
