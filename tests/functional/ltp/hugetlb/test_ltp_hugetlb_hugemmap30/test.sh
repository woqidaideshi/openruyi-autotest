#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap30
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap30"
        rlRun "kirk -f hugetlb -p hugemmap30 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap30"
