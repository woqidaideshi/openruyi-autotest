#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap27
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap27"
        rlRun "kirk -f hugetlb -p hugemmap27 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap27"
