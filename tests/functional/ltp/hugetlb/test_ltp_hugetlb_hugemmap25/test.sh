#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap25
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap25"
        rlRun "kirk -f hugetlb -p hugemmap25 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap25"
