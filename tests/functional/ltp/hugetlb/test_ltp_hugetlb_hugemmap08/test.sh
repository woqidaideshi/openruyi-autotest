#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap08
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap08"
        rlRun "kirk -f hugetlb -p hugemmap08 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap08"
