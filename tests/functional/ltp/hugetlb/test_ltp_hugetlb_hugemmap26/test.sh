#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap26
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap26"
        rlRun "kirk -f hugetlb -p hugemmap26 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap26"
