#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap05_3
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap05_3"
        rlRun "kirk -f hugetlb -p hugemmap05_3 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap05_3"
