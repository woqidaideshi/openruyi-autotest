#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap23
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap23"
        rlRun "kirk -f hugetlb -p hugemmap23 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap23"
