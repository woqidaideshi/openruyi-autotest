#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap05
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap05"
        rlRun "kirk -f hugetlb -p hugemmap05 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap05"
