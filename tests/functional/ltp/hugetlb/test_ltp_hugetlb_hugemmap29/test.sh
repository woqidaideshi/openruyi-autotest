#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap29
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap29"
        rlRun "kirk -f hugetlb -p hugemmap29 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap29"
