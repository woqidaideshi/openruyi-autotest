#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap28
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap28"
        rlRun "kirk -f hugetlb -p hugemmap28 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap28"
