#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap12
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap12"
        rlRun "kirk -f hugetlb -p hugemmap12 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap12"
