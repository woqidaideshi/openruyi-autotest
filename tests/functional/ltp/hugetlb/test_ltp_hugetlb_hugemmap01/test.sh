#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap01"
        rlRun "kirk -f hugetlb -p hugemmap01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap01"
