#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap04
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap04"
        rlRun "kirk -f hugetlb -p hugemmap04 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap04"
