#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap07
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap07"
        rlRun "kirk -f hugetlb -p hugemmap07 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap07"
