#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap19
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap19"
        rlRun "kirk -f hugetlb -p hugemmap19 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap19"
