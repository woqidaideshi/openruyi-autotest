#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap17
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap17"
        rlRun "kirk -f hugetlb -p hugemmap17 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap17"
