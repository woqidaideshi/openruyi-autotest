#!/bin/bash
# Functional test: ltp - hugetlb - hugefallocate02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugefallocate02"
        rlRun "kirk -f hugetlb -p hugefallocate02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugefallocate02"
