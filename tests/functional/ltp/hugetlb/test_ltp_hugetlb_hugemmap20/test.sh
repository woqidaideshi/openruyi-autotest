#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap20
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap20"
        rlRun "kirk -f hugetlb -p hugemmap20 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap20"
