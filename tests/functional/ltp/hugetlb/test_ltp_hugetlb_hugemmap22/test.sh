#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap22
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap22"
        rlRun "kirk -f hugetlb -p hugemmap22 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap22"
