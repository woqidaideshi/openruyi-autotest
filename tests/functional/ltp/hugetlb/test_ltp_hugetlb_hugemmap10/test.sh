#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap10
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap10"
        rlRun "kirk -f hugetlb -p hugemmap10 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap10"
