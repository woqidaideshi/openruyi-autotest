#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap34
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap34"
        rlRun "kirk -f hugetlb -p hugemmap34 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap34"
