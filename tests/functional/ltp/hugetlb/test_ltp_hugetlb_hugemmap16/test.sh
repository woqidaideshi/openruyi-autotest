#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap16"
        rlRun "kirk -f hugetlb -p hugemmap16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap16"
