#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap31
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap31"
        rlRun "kirk -f hugetlb -p hugemmap31 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap31"
