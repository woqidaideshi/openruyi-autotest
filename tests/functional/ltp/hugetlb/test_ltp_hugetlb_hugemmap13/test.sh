#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap13
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap13"
        rlRun "kirk -f hugetlb -p hugemmap13 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap13"
