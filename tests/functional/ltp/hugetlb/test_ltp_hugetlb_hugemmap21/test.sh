#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap21
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap21"
        rlRun "kirk -f hugetlb -p hugemmap21 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap21"
