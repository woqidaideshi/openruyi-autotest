#!/bin/bash
# Functional test: ltp - hugetlb - hugeshmat02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugeshmat02"
        rlRun "kirk -f hugetlb -p hugeshmat02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugeshmat02"
