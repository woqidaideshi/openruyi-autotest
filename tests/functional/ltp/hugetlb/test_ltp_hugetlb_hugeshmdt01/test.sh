#!/bin/bash
# Functional test: ltp - hugetlb - hugeshmdt01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugeshmdt01"
        rlRun "kirk -f hugetlb -p hugeshmdt01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugeshmdt01"
