#!/bin/bash
# Functional test: ltp - hugetlb - hugeshmget03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugeshmget03"
        rlRun "kirk -f hugetlb -p hugeshmget03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugeshmget03"
