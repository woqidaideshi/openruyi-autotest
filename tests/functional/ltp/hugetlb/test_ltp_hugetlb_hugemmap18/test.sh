#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap18
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap18"
        rlRun "kirk -f hugetlb -p hugemmap18 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap18"
