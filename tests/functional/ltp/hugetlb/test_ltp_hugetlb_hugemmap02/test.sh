#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap02"
        rlRun "kirk -f hugetlb -p hugemmap02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap02"
