#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap09
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap09"
        rlRun "kirk -f hugetlb -p hugemmap09 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap09"
