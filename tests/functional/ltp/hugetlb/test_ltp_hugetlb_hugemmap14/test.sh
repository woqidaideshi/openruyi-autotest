#!/bin/bash
# Functional test: ltp - hugetlb - hugemmap14
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugemmap14"
        rlRun "kirk -f hugetlb -p hugemmap14 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugemmap14"
