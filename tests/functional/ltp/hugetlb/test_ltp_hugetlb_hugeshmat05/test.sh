#!/bin/bash
# Functional test: ltp - hugetlb - hugeshmat05
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP hugetlb - hugeshmat05"
        rlRun "kirk -f hugetlb -p hugeshmat05 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP hugeshmat05"
