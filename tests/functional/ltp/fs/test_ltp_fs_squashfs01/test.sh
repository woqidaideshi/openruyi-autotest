#!/bin/bash
# Functional test: ltp - fs - squashfs01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP fs - squashfs01"
        rlRun "kirk -f fs -p squashfs01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP squashfs01"
