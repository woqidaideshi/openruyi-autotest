#!/bin/bash
# Functional test: ltp - fs - binfmt_misc02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP fs - binfmt_misc02"
        rlRun "kirk -f fs -p binfmt_misc02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP binfmt_misc02"
