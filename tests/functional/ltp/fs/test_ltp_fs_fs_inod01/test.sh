#!/bin/bash
# Functional test: ltp - fs - fs_inod01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP fs - fs_inod01"
        rlRun "kirk -f fs -p fs_inod01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fs_inod01"
