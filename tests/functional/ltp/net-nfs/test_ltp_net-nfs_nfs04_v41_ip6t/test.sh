#!/bin/bash
# Functional test: ltp - net-nfs - nfs04_v41_ip6t
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-nfs - nfs04_v41_ip6t"
        rlRun "kirk -f net-nfs -p nfs04_v41_ip6t 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP nfs04_v41_ip6t"
