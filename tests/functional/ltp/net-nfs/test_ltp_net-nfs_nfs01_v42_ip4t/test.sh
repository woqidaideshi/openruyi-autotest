#!/bin/bash
# Functional test: ltp - net-nfs - nfs01_v42_ip4t
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-nfs - nfs01_v42_ip4t"
        rlRun "kirk -f net-nfs -p nfs01_v42_ip4t 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP nfs01_v42_ip4t"
