#!/bin/bash
# Functional test: ltp - net-nfs - nfs05_v30_ip6u
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-nfs - nfs05_v30_ip6u"
        rlRun "kirk -f net-nfs -p nfs05_v30_ip6u 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP nfs05_v30_ip6u"
