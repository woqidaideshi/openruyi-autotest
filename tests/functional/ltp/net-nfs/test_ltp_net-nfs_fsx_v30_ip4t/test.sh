#!/bin/bash
# Functional test: ltp - net-nfs - fsx_v30_ip4t
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-nfs - fsx_v30_ip4t"
        rlRun "kirk -f net-nfs -p fsx_v30_ip4t 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fsx_v30_ip4t"
