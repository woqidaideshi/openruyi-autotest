#!/bin/bash
# Functional test: ltp - net-nfs - nfs08_v40_ip6t
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-nfs - nfs08_v40_ip6t"
        rlRun "kirk -f net-nfs -p nfs08_v40_ip6t 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP nfs08_v40_ip6t"
