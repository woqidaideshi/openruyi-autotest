#!/bin/bash
# Functional test: ltp - net-nfs - nfs03_v30_ip4u
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-nfs - nfs03_v30_ip4u"
        rlRun "kirk -f net-nfs -p nfs03_v30_ip4u 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP nfs03_v30_ip4u"
