#!/bin/bash
# Functional test: ltp - net-features - ipvlan01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - ipvlan01"
        rlRun "kirk -f net-features -p ipvlan01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP ipvlan01"
