#!/bin/bash
# Functional test: ltp - net-features - dctcp_ipv4_01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - dctcp_ipv4_01"
        rlRun "kirk -f net-features -p dctcp_ipv4_01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP dctcp_ipv4_01"
