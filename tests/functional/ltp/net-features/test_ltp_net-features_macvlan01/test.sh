#!/bin/bash
# Functional test: ltp - net-features - macvlan01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - macvlan01"
        rlRun "kirk -f net-features -p macvlan01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP macvlan01"
