#!/bin/bash
# Functional test: ltp - net-features - fanout01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - fanout01"
        rlRun "kirk -f net-features -p fanout01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fanout01"
