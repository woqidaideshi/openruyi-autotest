#!/bin/bash
# Functional test: ltp - net-features - mpls04
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - mpls04"
        rlRun "kirk -f net-features -p mpls04 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mpls04"
