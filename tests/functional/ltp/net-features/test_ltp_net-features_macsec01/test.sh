#!/bin/bash
# Functional test: ltp - net-features - macsec01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - macsec01"
        rlRun "kirk -f net-features -p macsec01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP macsec01"
