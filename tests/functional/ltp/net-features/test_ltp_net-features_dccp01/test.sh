#!/bin/bash
# Functional test: ltp - net-features - dccp01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - dccp01"
        rlRun "kirk -f net-features -p dccp01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP dccp01"
