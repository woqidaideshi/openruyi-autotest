#!/bin/bash
# Functional test: ltp - net-features - dccp01_ipv6
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - dccp01_ipv6"
        rlRun "kirk -f net-features -p dccp01_ipv6 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP dccp01_ipv6"
