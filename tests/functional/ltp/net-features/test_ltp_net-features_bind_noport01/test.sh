#!/bin/bash
# Functional test: ltp - net-features - bind_noport01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - bind_noport01"
        rlRun "kirk -f net-features -p bind_noport01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP bind_noport01"
