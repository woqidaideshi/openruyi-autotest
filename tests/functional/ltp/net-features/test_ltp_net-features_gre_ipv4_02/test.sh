#!/bin/bash
# Functional test: ltp - net-features - gre_ipv4_02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - gre_ipv4_02"
        rlRun "kirk -f net-features -p gre_ipv4_02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP gre_ipv4_02"
