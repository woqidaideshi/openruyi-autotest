#!/bin/bash
# Functional test: ltp - net-features - sctp01_ipv6
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - sctp01_ipv6"
        rlRun "kirk -f net-features -p sctp01_ipv6 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP sctp01_ipv6"
