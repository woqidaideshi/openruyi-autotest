#!/bin/bash
# Functional test: ltp - net-features - gue01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - gue01"
        rlRun "kirk -f net-features -p gue01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP gue01"
