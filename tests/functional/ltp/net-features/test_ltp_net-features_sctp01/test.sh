#!/bin/bash
# Functional test: ltp - net-features - sctp01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - sctp01"
        rlRun "kirk -f net-features -p sctp01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP sctp01"
