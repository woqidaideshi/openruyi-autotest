#!/bin/bash
# Functional test: ltp - net-features - bbr02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - bbr02"
        rlRun "kirk -f net-features -p bbr02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP bbr02"
