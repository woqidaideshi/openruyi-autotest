#!/bin/bash
# Functional test: ltp - net-features - vxlan02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - vxlan02"
        rlRun "kirk -f net-features -p vxlan02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP vxlan02"
