#!/bin/bash
# Functional test: ltp - net-features - macsec03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - macsec03"
        rlRun "kirk -f net-features -p macsec03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP macsec03"
