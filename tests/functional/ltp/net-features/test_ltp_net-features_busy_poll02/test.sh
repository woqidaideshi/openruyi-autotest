#!/bin/bash
# Functional test: ltp - net-features - busy_poll02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - busy_poll02"
        rlRun "kirk -f net-features -p busy_poll02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP busy_poll02"
