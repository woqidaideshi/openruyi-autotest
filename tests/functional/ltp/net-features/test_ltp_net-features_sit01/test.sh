#!/bin/bash
# Functional test: ltp - net-features - sit01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - sit01"
        rlRun "kirk -f net-features -p sit01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP sit01"
