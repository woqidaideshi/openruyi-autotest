#!/bin/bash
# Functional test: ltp - net-features - vxlan01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - vxlan01"
        rlRun "kirk -f net-features -p vxlan01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP vxlan01"
