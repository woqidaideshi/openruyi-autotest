#!/bin/bash
# Functional test: ltp - net-features - mpls03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - mpls03"
        rlRun "kirk -f net-features -p mpls03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mpls03"
