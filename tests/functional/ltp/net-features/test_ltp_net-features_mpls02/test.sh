#!/bin/bash
# Functional test: ltp - net-features - mpls02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - mpls02"
        rlRun "kirk -f net-features -p mpls02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mpls02"
