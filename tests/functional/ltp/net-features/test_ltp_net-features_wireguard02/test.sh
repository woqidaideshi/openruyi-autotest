#!/bin/bash
# Functional test: ltp - net-features - wireguard02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - wireguard02"
        rlRun "kirk -f net-features -p wireguard02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP wireguard02"
