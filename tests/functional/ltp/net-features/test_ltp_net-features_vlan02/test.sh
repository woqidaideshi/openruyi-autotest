#!/bin/bash
# Functional test: ltp - net-features - vlan02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - vlan02"
        rlRun "kirk -f net-features -p vlan02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP vlan02"
