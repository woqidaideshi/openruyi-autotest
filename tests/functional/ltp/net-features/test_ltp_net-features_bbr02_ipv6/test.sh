#!/bin/bash
# Functional test: ltp - net-features - bbr02_ipv6
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - bbr02_ipv6"
        rlRun "kirk -f net-features -p bbr02_ipv6 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP bbr02_ipv6"
