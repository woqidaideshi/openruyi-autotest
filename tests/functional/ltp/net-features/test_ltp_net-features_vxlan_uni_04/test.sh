#!/bin/bash
# Functional test: ltp - net-features - vxlan_uni_04
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - vxlan_uni_04"
        rlRun "kirk -f net-features -p vxlan_uni_04 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP vxlan_uni_04"
