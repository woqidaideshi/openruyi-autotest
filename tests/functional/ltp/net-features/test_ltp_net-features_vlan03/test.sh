#!/bin/bash
# Functional test: ltp - net-features - vlan03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - vlan03"
        rlRun "kirk -f net-features -p vlan03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP vlan03"
