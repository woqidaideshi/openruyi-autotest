#!/bin/bash
# Functional test: ltp - net-features - bbr01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - bbr01"
        rlRun "kirk -f net-features -p bbr01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP bbr01"
