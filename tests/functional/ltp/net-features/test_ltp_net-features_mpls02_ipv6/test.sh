#!/bin/bash
# Functional test: ltp - net-features - mpls02_ipv6
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - mpls02_ipv6"
        rlRun "kirk -f net-features -p mpls02_ipv6 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mpls02_ipv6"
