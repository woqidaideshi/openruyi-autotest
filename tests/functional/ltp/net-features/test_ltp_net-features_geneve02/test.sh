#!/bin/bash
# Functional test: ltp - net-features - geneve02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - geneve02"
        rlRun "kirk -f net-features -p geneve02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP geneve02"
