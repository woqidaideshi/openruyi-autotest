#!/bin/bash
# Functional test: ltp - net-features - macvtap01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - macvtap01"
        rlRun "kirk -f net-features -p macvtap01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP macvtap01"
