#!/bin/bash
# Functional test: ltp - net-features - vlan01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - vlan01"
        rlRun "kirk -f net-features -p vlan01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP vlan01"
