#!/bin/bash
# Functional test: ltp - net-features - geneve01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - geneve01"
        rlRun "kirk -f net-features -p geneve01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP geneve01"
