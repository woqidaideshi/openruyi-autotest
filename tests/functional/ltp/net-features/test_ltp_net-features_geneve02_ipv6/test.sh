#!/bin/bash
# Functional test: ltp - net-features - geneve02_ipv6
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-features - geneve02_ipv6"
        rlRun "kirk -f net-features -p geneve02_ipv6 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP geneve02_ipv6"
