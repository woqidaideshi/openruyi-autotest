#!/bin/bash
# Functional test: ltp - mm - swapping01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP mm - swapping01"
        rlRun "kirk -f mm -p swapping01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP swapping01"
