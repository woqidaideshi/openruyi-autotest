#!/bin/bash
# Functional test: ltp - mm - mtest06_2
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP mm - mtest06_2"
        rlRun "kirk -f mm -p mtest06_2 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mtest06_2"
