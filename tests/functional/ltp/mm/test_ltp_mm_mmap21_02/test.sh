#!/bin/bash
# Functional test: ltp - mm - mmap21_02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP mm - mmap21_02"
        rlRun "kirk -f mm -p mmap21_02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mmap21_02"
