#!/bin/bash
# Functional test: ltp - mm - overcommit_memory02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP mm - overcommit_memory02"
        rlRun "kirk -f mm -p overcommit_memory02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP overcommit_memory02"
