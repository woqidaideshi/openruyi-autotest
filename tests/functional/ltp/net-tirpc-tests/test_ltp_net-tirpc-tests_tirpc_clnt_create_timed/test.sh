#!/bin/bash
# Functional test: ltp - net-tirpc-tests - tirpc_clnt_create_timed
...
rlJournalStart
    ...
    rlRun "_ltpRunCase net-tirpc-tests tirpc_clnt_create_timed" 0 "Execute LTP tirpc_clnt_create_timed"
    rlPhaseEnd
