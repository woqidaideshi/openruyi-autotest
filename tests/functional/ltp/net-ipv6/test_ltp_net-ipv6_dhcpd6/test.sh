#!/bin/bash
# Functional test: ltp - net-ipv6 - dhcpd6
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-ipv6 - dhcpd6"
        rlRun "kirk -f net-ipv6 -p dhcpd6 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP dhcpd6"
