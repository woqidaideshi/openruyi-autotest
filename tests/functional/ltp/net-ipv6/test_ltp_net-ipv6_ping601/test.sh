#!/bin/bash
# Functional test: ltp - net-ipv6 - ping601
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-ipv6 - ping601"
        rlRun "kirk -f net-ipv6 -p ping601 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP ping601"
