#!/bin/bash
# Functional test: ltp - net-ipv6 - tracepath601
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-ipv6 - tracepath601"
        rlRun "kirk -f net-ipv6 -p tracepath601 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP tracepath601"
