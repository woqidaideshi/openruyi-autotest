#!/bin/bash
# Functional test: ltp - net-ipv6 - dnsmasq6
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-ipv6 - dnsmasq6"
        rlRun "kirk -f net-ipv6 -p dnsmasq6 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP dnsmasq6"
