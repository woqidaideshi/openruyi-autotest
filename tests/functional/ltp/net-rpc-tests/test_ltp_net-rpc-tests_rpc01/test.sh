#!/bin/bash
# Functional test: ltp - net-rpc-tests - rpc01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-rpc-tests - rpc01"
        rlRun "kirk -f net-rpc-tests -p rpc01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP rpc01"
