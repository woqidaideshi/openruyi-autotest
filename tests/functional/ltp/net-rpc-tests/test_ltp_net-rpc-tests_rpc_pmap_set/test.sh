#!/bin/bash
# Functional test: ltp - net-rpc-tests - rpc_pmap_set
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-rpc-tests - rpc_pmap_set"
        rlRun "kirk -f net-rpc-tests -p rpc_pmap_set 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP rpc_pmap_set"
