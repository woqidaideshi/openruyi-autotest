#!/bin/bash
# Functional test: ltp - numa - move_pages07
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP numa - move_pages07"
        rlRun "kirk -f numa -p move_pages07 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP move_pages07"
