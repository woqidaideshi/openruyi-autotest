#!/bin/bash
# Functional test: ltp - numa - move_pages02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP numa - move_pages02"
        rlRun "kirk -f numa -p move_pages02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP move_pages02"
