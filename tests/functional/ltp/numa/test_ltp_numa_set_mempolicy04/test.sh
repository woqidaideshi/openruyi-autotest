#!/bin/bash
# Functional test: ltp - numa - set_mempolicy04
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP numa - set_mempolicy04"
        rlRun "kirk -f numa -p set_mempolicy04 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP set_mempolicy04"
