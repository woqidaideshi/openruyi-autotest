#!/bin/bash
# Functional test: ltp - net-tcp-cmds - arping01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-tcp-cmds - arping01"
        rlRun "kirk -f net-tcp-cmds -p arping01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP arping01"
