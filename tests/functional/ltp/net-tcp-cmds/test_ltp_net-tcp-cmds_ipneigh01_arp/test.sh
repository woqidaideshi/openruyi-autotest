#!/bin/bash
# Functional test: ltp - net-tcp-cmds - ipneigh01_arp
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-tcp-cmds - ipneigh01_arp"
        rlRun "kirk -f net-tcp-cmds -p ipneigh01_arp 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP ipneigh01_arp"
