#!/bin/bash
# Functional test: ltp - net-tcp-cmds - tc01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-tcp-cmds - tc01"
        rlRun "kirk -f net-tcp-cmds -p tc01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP tc01"
