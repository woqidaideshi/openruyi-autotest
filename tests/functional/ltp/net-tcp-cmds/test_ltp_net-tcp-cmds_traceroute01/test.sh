#!/bin/bash
# Functional test: ltp - net-tcp-cmds - traceroute01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-tcp-cmds - traceroute01"
        rlRun "kirk -f net-tcp-cmds -p traceroute01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP traceroute01"
