#!/bin/bash
# Functional test: ltp - net-sctp - test_1_to_1_send
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-sctp - test_1_to_1_send"
        rlRun "kirk -f net-sctp -p test_1_to_1_send 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP test_1_to_1_send"
