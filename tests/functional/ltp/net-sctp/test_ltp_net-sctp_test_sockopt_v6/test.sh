#!/bin/bash
# Functional test: ltp - net-sctp - test_sockopt_v6
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-sctp - test_sockopt_v6"
        rlRun "kirk -f net-sctp -p test_sockopt_v6 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP test_sockopt_v6"
