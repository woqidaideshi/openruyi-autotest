#!/bin/bash
# Functional test: ltp - net-sctp - test_fragments
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-sctp - test_fragments"
        rlRun "kirk -f net-sctp -p test_fragments 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP test_fragments"
