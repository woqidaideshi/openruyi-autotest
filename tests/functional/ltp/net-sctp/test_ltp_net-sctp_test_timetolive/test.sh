#!/bin/bash
# Functional test: ltp - net-sctp - test_timetolive
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-sctp - test_timetolive"
        rlRun "kirk -f net-sctp -p test_timetolive 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP test_timetolive"
