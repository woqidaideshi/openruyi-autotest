#!/bin/bash
# Functional test: ltp - net-sctp - test_autoclose
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-sctp - test_autoclose"
        rlRun "kirk -f net-sctp -p test_autoclose 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP test_autoclose"
