#!/bin/bash
# Functional test: ltp - ima - ima_selinux
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP ima - ima_selinux"
        rlRun "kirk -f ima -p ima_selinux 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP ima_selinux"
