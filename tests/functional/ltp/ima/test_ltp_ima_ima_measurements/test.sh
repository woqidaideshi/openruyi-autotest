#!/bin/bash
# Functional test: ltp - ima - ima_measurements
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP ima - ima_measurements"
        rlRun "kirk -f ima -p ima_measurements 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP ima_measurements"
