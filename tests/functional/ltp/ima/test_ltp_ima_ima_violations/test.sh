#!/bin/bash
# Functional test: ltp - ima - ima_violations
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP ima - ima_violations"
        rlRun "kirk -f ima -p ima_violations 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP ima_violations"
