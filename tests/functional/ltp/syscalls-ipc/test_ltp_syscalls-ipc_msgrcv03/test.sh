#!/bin/bash
# Functional test: ltp - syscalls-ipc - msgrcv03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls-ipc - msgrcv03"
        rlRun "kirk -f syscalls-ipc -p msgrcv03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP msgrcv03"
