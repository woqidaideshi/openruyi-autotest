#!/bin/bash
# Functional test: ltp - syscalls-ipc - msgrcv02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls-ipc - msgrcv02"
        rlRun "kirk -f syscalls-ipc -p msgrcv02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP msgrcv02"
