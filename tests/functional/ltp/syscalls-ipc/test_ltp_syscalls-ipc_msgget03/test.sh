#!/bin/bash
# Functional test: ltp - syscalls-ipc - msgget03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls-ipc - msgget03"
        rlRun "kirk -f syscalls-ipc -p msgget03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP msgget03"
