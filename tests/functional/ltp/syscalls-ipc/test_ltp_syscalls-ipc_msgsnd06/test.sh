#!/bin/bash
# Functional test: ltp - syscalls-ipc - msgsnd06
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls-ipc - msgsnd06"
        rlRun "kirk -f syscalls-ipc -p msgsnd06 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP msgsnd06"
