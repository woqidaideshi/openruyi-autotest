#!/bin/bash
# Functional test: ltp - syscalls-ipc - msgstress01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls-ipc - msgstress01"
        rlRun "kirk -f syscalls-ipc -p msgstress01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP msgstress01"
