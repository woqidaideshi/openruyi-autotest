#!/bin/bash
# Functional test: ltp - syscalls-ipc - shmget03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls-ipc - shmget03"
        rlRun "kirk -f syscalls-ipc -p shmget03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP shmget03"
