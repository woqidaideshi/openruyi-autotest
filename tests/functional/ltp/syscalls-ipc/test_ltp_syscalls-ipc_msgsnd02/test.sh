#!/bin/bash
# Functional test: ltp - syscalls-ipc - msgsnd02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls-ipc - msgsnd02"
        rlRun "kirk -f syscalls-ipc -p msgsnd02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP msgsnd02"
