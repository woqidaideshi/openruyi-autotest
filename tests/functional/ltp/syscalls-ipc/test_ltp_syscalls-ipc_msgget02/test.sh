#!/bin/bash
# Functional test: ltp - syscalls-ipc - msgget02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls-ipc - msgget02"
        rlRun "kirk -f syscalls-ipc -p msgget02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP msgget02"
