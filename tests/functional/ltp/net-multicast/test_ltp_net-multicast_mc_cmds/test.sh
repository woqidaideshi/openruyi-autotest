#!/bin/bash
# Functional test: ltp - net-multicast - mc_cmds
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP net-multicast - mc_cmds"
        rlRun "kirk -f net-multicast -p mc_cmds 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mc_cmds"
