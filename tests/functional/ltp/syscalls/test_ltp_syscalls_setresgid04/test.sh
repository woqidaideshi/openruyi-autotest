#!/bin/bash
# Functional test: ltp - syscalls - setresgid04
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setresgid04"
        rlRun "kirk -f syscalls -p setresgid04 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setresgid04"
