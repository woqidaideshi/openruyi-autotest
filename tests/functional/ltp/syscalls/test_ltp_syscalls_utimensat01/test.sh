#!/bin/bash
# Functional test: ltp - syscalls - utimensat01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - utimensat01"
        rlRun "kirk -f syscalls -p utimensat01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP utimensat01"
