#!/bin/bash
# Functional test: ltp - syscalls - statfs03_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - statfs03_64"
        rlRun "kirk -f syscalls -p statfs03_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP statfs03_64"
