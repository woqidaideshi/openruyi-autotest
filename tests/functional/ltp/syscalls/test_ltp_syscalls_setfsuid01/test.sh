#!/bin/bash
# Functional test: ltp - syscalls - setfsuid01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setfsuid01"
        rlRun "kirk -f syscalls -p setfsuid01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setfsuid01"
