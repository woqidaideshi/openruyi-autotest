#!/bin/bash
# Functional test: ltp - syscalls - truncate02_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - truncate02_64"
        rlRun "kirk -f syscalls -p truncate02_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP truncate02_64"
