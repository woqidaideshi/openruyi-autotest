#!/bin/bash
# Functional test: ltp - syscalls - pread01_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - pread01_64"
        rlRun "kirk -f syscalls -p pread01_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP pread01_64"
