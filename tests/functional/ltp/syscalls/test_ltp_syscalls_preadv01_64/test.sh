#!/bin/bash
# Functional test: ltp - syscalls - preadv01_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - preadv01_64"
        rlRun "kirk -f syscalls -p preadv01_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP preadv01_64"
