#!/bin/bash
# Functional test: ltp - syscalls - setuid04_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setuid04_16"
        rlRun "kirk -f syscalls -p setuid04_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setuid04_16"
