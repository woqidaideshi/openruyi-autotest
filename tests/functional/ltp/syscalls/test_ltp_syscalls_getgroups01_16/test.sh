#!/bin/bash
# Functional test: ltp - syscalls - getgroups01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getgroups01_16"
        rlRun "kirk -f syscalls -p getgroups01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getgroups01_16"
