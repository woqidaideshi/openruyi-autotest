#!/bin/bash
# Functional test: ltp - syscalls - getresgid01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getresgid01_16"
        rlRun "kirk -f syscalls -p getresgid01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getresgid01_16"
