#!/bin/bash
# Functional test: ltp - syscalls - setdomainname02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setdomainname02"
        rlRun "kirk -f syscalls -p setdomainname02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setdomainname02"
