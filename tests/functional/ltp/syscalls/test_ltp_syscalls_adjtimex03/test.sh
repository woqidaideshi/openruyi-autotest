#!/bin/bash
# Functional test: ltp - syscalls - adjtimex03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - adjtimex03"
        rlRun "kirk -f syscalls -p adjtimex03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP adjtimex03"
