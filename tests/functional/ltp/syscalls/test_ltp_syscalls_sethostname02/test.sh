#!/bin/bash
# Functional test: ltp - syscalls - sethostname02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - sethostname02"
        rlRun "kirk -f syscalls -p sethostname02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP sethostname02"
