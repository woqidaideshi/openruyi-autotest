#!/bin/bash
# Functional test: ltp - syscalls - setregid03_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setregid03_16"
        rlRun "kirk -f syscalls -p setregid03_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setregid03_16"
