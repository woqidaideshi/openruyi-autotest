#!/bin/bash
# Functional test: ltp - syscalls - fcntl31_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fcntl31_64"
        rlRun "kirk -f syscalls -p fcntl31_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fcntl31_64"
