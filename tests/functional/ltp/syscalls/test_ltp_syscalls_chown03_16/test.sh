#!/bin/bash
# Functional test: ltp - syscalls - chown03_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - chown03_16"
        rlRun "kirk -f syscalls -p chown03_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP chown03_16"
