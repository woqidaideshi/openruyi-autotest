#!/bin/bash
# Functional test: ltp - syscalls - eventfd2_03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - eventfd2_03"
        rlRun "kirk -f syscalls -p eventfd2_03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP eventfd2_03"
