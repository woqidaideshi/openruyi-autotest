#!/bin/bash
# Functional test: ltp - syscalls - gethostname02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - gethostname02"
        rlRun "kirk -f syscalls -p gethostname02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP gethostname02"
