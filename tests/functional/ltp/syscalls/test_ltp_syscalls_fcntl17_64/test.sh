#!/bin/bash
# Functional test: ltp - syscalls - fcntl17_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fcntl17_64"
        rlRun "kirk -f syscalls -p fcntl17_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fcntl17_64"
