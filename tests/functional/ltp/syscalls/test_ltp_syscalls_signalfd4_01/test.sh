#!/bin/bash
# Functional test: ltp - syscalls - signalfd4_01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - signalfd4_01"
        rlRun "kirk -f syscalls -p signalfd4_01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP signalfd4_01"
