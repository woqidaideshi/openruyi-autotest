#!/bin/bash
# Functional test: ltp - syscalls - llistxattr02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - llistxattr02"
        rlRun "kirk -f syscalls -p llistxattr02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP llistxattr02"
