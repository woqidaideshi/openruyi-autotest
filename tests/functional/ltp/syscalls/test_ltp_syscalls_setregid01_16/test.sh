#!/bin/bash
# Functional test: ltp - syscalls - setregid01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setregid01_16"
        rlRun "kirk -f syscalls -p setregid01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setregid01_16"
