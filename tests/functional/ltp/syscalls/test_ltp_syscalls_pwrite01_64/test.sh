#!/bin/bash
# Functional test: ltp - syscalls - pwrite01_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - pwrite01_64"
        rlRun "kirk -f syscalls -p pwrite01_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP pwrite01_64"
