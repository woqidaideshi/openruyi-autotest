#!/bin/bash
# Functional test: ltp - syscalls - preadv202_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - preadv202_64"
        rlRun "kirk -f syscalls -p preadv202_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP preadv202_64"
