#!/bin/bash
# Functional test: ltp - syscalls - setfsgid03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setfsgid03"
        rlRun "kirk -f syscalls -p setfsgid03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setfsgid03"
