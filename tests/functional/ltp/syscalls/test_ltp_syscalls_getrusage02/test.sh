#!/bin/bash
# Functional test: ltp - syscalls - getrusage02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getrusage02"
        rlRun "kirk -f syscalls -p getrusage02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getrusage02"
