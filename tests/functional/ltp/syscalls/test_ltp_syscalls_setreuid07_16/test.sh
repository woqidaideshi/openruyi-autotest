#!/bin/bash
# Functional test: ltp - syscalls - setreuid07_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setreuid07_16"
        rlRun "kirk -f syscalls -p setreuid07_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setreuid07_16"
