#!/bin/bash
# Functional test: ltp - syscalls - open03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - open03"
        rlRun "kirk -f syscalls -p open03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP open03"
