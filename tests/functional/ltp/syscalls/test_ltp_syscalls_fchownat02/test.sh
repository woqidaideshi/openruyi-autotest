#!/bin/bash
# Functional test: ltp - syscalls - fchownat02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fchownat02"
        rlRun "kirk -f syscalls -p fchownat02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fchownat02"
