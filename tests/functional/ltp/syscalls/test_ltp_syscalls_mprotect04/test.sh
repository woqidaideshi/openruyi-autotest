#!/bin/bash
# Functional test: ltp - syscalls - mprotect04
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - mprotect04"
        rlRun "kirk -f syscalls -p mprotect04 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mprotect04"
