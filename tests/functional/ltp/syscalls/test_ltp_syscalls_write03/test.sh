#!/bin/bash
# Functional test: ltp - syscalls - write03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - write03"
        rlRun "kirk -f syscalls -p write03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP write03"
