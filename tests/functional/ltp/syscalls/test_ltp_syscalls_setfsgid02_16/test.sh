#!/bin/bash
# Functional test: ltp - syscalls - setfsgid02_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setfsgid02_16"
        rlRun "kirk -f syscalls -p setfsgid02_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setfsgid02_16"
