#!/bin/bash
# Functional test: ltp - syscalls - nice03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - nice03"
        rlRun "kirk -f syscalls -p nice03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP nice03"
