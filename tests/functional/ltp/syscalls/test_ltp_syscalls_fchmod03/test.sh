#!/bin/bash
# Functional test: ltp - syscalls - fchmod03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fchmod03"
        rlRun "kirk -f syscalls -p fchmod03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fchmod03"
