#!/bin/bash
# Functional test: ltp - syscalls - getresgid02_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getresgid02_16"
        rlRun "kirk -f syscalls -p getresgid02_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getresgid02_16"
