#!/bin/bash
# Functional test: ltp - syscalls - fcntl15_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fcntl15_64"
        rlRun "kirk -f syscalls -p fcntl15_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fcntl15_64"
