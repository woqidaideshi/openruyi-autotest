#!/bin/bash
# Functional test: ltp - syscalls - lchown01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - lchown01_16"
        rlRun "kirk -f syscalls -p lchown01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP lchown01_16"
