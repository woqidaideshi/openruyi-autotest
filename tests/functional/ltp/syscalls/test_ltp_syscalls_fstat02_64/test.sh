#!/bin/bash
# Functional test: ltp - syscalls - fstat02_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fstat02_64"
        rlRun "kirk -f syscalls -p fstat02_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fstat02_64"
