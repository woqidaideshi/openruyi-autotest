#!/bin/bash
# Functional test: ltp - syscalls - setresuid04_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setresuid04_16"
        rlRun "kirk -f syscalls -p setresuid04_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setresuid04_16"
