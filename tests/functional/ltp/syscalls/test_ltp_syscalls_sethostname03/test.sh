#!/bin/bash
# Functional test: ltp - syscalls - sethostname03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - sethostname03"
        rlRun "kirk -f syscalls -p sethostname03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP sethostname03"
