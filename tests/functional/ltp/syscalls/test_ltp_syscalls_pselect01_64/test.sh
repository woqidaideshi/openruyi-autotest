#!/bin/bash
# Functional test: ltp - syscalls - pselect01_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - pselect01_64"
        rlRun "kirk -f syscalls -p pselect01_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP pselect01_64"
