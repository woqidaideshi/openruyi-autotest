#!/bin/bash
# Functional test: ltp - syscalls - sendfile03_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - sendfile03_64"
        rlRun "kirk -f syscalls -p sendfile03_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP sendfile03_64"
