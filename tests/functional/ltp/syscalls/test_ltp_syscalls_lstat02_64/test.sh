#!/bin/bash
# Functional test: ltp - syscalls - lstat02_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - lstat02_64"
        rlRun "kirk -f syscalls -p lstat02_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP lstat02_64"
