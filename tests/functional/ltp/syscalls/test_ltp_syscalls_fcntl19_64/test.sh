#!/bin/bash
# Functional test: ltp - syscalls - fcntl19_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fcntl19_64"
        rlRun "kirk -f syscalls -p fcntl19_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fcntl19_64"
