#!/bin/bash
# Functional test: ltp - syscalls - lstat03_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - lstat03_64"
        rlRun "kirk -f syscalls -p lstat03_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP lstat03_64"
