#!/bin/bash
# Functional test: ltp - syscalls - setresgid03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setresgid03"
        rlRun "kirk -f syscalls -p setresgid03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setresgid03"
