#!/bin/bash
# Functional test: ltp - syscalls - mallinfo2_01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - mallinfo2_01"
        rlRun "kirk -f syscalls -p mallinfo2_01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mallinfo2_01"
