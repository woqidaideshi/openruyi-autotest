#!/bin/bash
# Functional test: ltp - syscalls - recvmsg03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - recvmsg03"
        rlRun "kirk -f syscalls -p recvmsg03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP recvmsg03"
