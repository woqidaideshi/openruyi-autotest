#!/bin/bash
# Functional test: ltp - syscalls - fchmodat01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fchmodat01"
        rlRun "kirk -f syscalls -p fchmodat01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fchmodat01"
