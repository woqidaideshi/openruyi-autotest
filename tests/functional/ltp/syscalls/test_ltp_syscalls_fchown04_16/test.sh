#!/bin/bash
# Functional test: ltp - syscalls - fchown04_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fchown04_16"
        rlRun "kirk -f syscalls -p fchown04_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fchown04_16"
