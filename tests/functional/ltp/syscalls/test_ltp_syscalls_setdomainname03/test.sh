#!/bin/bash
# Functional test: ltp - syscalls - setdomainname03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setdomainname03"
        rlRun "kirk -f syscalls -p setdomainname03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setdomainname03"
