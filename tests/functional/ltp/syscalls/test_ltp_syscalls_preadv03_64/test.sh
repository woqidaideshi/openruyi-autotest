#!/bin/bash
# Functional test: ltp - syscalls - preadv03_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - preadv03_64"
        rlRun "kirk -f syscalls -p preadv03_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP preadv03_64"
