#!/bin/bash
# Functional test: ltp - syscalls - kcmp03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - kcmp03"
        rlRun "kirk -f syscalls -p kcmp03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP kcmp03"
