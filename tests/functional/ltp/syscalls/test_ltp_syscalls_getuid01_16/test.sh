#!/bin/bash
# Functional test: ltp - syscalls - getuid01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getuid01_16"
        rlRun "kirk -f syscalls -p getuid01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getuid01_16"
