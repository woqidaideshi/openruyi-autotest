#!/bin/bash
# Functional test: ltp - syscalls - personality01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - personality01"
        rlRun "kirk -f syscalls -p personality01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP personality01"
