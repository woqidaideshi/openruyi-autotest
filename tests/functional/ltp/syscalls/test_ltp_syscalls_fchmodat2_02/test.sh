#!/bin/bash
# Functional test: ltp - syscalls - fchmodat2_02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fchmodat2_02"
        rlRun "kirk -f syscalls -p fchmodat2_02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fchmodat2_02"
