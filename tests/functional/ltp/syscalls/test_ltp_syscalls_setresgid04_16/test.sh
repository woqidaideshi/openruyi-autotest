#!/bin/bash
# Functional test: ltp - syscalls - setresgid04_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setresgid04_16"
        rlRun "kirk -f syscalls -p setresgid04_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setresgid04_16"
