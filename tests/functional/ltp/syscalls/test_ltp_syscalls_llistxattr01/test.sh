#!/bin/bash
# Functional test: ltp - syscalls - llistxattr01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - llistxattr01"
        rlRun "kirk -f syscalls -p llistxattr01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP llistxattr01"
