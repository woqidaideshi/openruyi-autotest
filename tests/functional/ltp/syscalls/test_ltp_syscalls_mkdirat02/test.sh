#!/bin/bash
# Functional test: ltp - syscalls - mkdirat02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - mkdirat02"
        rlRun "kirk -f syscalls -p mkdirat02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mkdirat02"
