#!/bin/bash
# Functional test: ltp - syscalls - fcntl03_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fcntl03_64"
        rlRun "kirk -f syscalls -p fcntl03_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fcntl03_64"
