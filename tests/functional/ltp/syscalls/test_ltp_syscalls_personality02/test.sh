#!/bin/bash
# Functional test: ltp - syscalls - personality02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - personality02"
        rlRun "kirk -f syscalls -p personality02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP personality02"
