#!/bin/bash
# Functional test: ltp - syscalls - fchmodat2_01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fchmodat2_01"
        rlRun "kirk -f syscalls -p fchmodat2_01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fchmodat2_01"
