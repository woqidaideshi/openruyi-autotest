#!/bin/bash
# Functional test: ltp - syscalls - lchown02_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - lchown02_16"
        rlRun "kirk -f syscalls -p lchown02_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP lchown02_16"
