#!/bin/bash
# Functional test: ltp - syscalls - setresuid02_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setresuid02_16"
        rlRun "kirk -f syscalls -p setresuid02_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setresuid02_16"
