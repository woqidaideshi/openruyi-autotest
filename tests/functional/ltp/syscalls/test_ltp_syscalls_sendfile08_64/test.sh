#!/bin/bash
# Functional test: ltp - syscalls - sendfile08_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - sendfile08_64"
        rlRun "kirk -f syscalls -p sendfile08_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP sendfile08_64"
