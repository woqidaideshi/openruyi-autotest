#!/bin/bash
# Functional test: ltp - syscalls - geteuid02_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - geteuid02_16"
        rlRun "kirk -f syscalls -p geteuid02_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP geteuid02_16"
