#!/bin/bash
# Functional test: ltp - syscalls - getrandom04
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getrandom04"
        rlRun "kirk -f syscalls -p getrandom04 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getrandom04"
