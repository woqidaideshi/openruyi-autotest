#!/bin/bash
# Functional test: ltp - syscalls - setuid03_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setuid03_16"
        rlRun "kirk -f syscalls -p setuid03_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setuid03_16"
