#!/bin/bash
# Functional test: ltp - syscalls - setgid03_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setgid03_16"
        rlRun "kirk -f syscalls -p setgid03_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setgid03_16"
