#!/bin/bash
# Functional test: ltp - syscalls - setreuid03_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setreuid03_16"
        rlRun "kirk -f syscalls -p setreuid03_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setreuid03_16"
