#!/bin/bash
# Functional test: ltp - syscalls - setgroups01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setgroups01_16"
        rlRun "kirk -f syscalls -p setgroups01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setgroups01_16"
