#!/bin/bash
# Functional test: ltp - syscalls - getgid03_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getgid03_16"
        rlRun "kirk -f syscalls -p getgid03_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getgid03_16"
