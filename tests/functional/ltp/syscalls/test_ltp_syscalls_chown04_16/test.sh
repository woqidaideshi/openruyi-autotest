#!/bin/bash
# Functional test: ltp - syscalls - chown04_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - chown04_16"
        rlRun "kirk -f syscalls -p chown04_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP chown04_16"
