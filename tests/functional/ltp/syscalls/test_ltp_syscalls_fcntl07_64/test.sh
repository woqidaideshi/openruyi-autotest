#!/bin/bash
# Functional test: ltp - syscalls - fcntl07_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fcntl07_64"
        rlRun "kirk -f syscalls -p fcntl07_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fcntl07_64"
