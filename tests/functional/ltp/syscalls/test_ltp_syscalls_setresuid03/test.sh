#!/bin/bash
# Functional test: ltp - syscalls - setresuid03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setresuid03"
        rlRun "kirk -f syscalls -p setresuid03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setresuid03"
