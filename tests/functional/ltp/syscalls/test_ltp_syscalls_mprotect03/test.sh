#!/bin/bash
# Functional test: ltp - syscalls - mprotect03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - mprotect03"
        rlRun "kirk -f syscalls -p mprotect03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mprotect03"
