#!/bin/bash
# Functional test: ltp - syscalls - fchown05_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fchown05_16"
        rlRun "kirk -f syscalls -p fchown05_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fchown05_16"
