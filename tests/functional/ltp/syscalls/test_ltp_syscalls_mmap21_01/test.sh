#!/bin/bash
# Functional test: ltp - syscalls - mmap21_01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - mmap21_01"
        rlRun "kirk -f syscalls -p mmap21_01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP mmap21_01"
