#!/bin/bash
# Functional test: ltp - syscalls - fcntl18_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fcntl18_64"
        rlRun "kirk -f syscalls -p fcntl18_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fcntl18_64"
