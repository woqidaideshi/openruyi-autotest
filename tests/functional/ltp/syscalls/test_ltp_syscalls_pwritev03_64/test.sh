#!/bin/bash
# Functional test: ltp - syscalls - pwritev03_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - pwritev03_64"
        rlRun "kirk -f syscalls -p pwritev03_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP pwritev03_64"
