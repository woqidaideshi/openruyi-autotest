#!/bin/bash
# Functional test: ltp - syscalls - setgid02_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setgid02_16"
        rlRun "kirk -f syscalls -p setgid02_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setgid02_16"
