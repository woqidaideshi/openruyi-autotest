#!/bin/bash
# Functional test: ltp - syscalls - setresuid05_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setresuid05_16"
        rlRun "kirk -f syscalls -p setresuid05_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setresuid05_16"
