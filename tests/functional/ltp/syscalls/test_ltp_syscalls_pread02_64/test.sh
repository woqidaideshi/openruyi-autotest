#!/bin/bash
# Functional test: ltp - syscalls - pread02_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - pread02_64"
        rlRun "kirk -f syscalls -p pread02_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP pread02_64"
