#!/bin/bash
# Functional test: ltp - syscalls - stat03_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - stat03_64"
        rlRun "kirk -f syscalls -p stat03_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP stat03_64"
