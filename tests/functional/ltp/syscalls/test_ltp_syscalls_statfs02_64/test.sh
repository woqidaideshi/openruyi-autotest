#!/bin/bash
# Functional test: ltp - syscalls - statfs02_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - statfs02_64"
        rlRun "kirk -f syscalls -p statfs02_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP statfs02_64"
