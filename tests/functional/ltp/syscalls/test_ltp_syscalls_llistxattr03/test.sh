#!/bin/bash
# Functional test: ltp - syscalls - llistxattr03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - llistxattr03"
        rlRun "kirk -f syscalls -p llistxattr03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP llistxattr03"
