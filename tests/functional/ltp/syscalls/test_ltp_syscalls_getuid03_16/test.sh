#!/bin/bash
# Functional test: ltp - syscalls - getuid03_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getuid03_16"
        rlRun "kirk -f syscalls -p getuid03_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getuid03_16"
