#!/bin/bash
# Functional test: ltp - syscalls - getitimer02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getitimer02"
        rlRun "kirk -f syscalls -p getitimer02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getitimer02"
