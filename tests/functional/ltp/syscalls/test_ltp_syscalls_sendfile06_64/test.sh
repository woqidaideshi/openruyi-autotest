#!/bin/bash
# Functional test: ltp - syscalls - sendfile06_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - sendfile06_64"
        rlRun "kirk -f syscalls -p sendfile06_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP sendfile06_64"
