#!/bin/bash
# Functional test: ltp - syscalls - inotify_init1_02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - inotify_init1_02"
        rlRun "kirk -f syscalls -p inotify_init1_02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP inotify_init1_02"
