#!/bin/bash
# Functional test: ltp - syscalls - setreuid02_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setreuid02_16"
        rlRun "kirk -f syscalls -p setreuid02_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setreuid02_16"
