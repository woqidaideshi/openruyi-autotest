#!/bin/bash
# Functional test: ltp - syscalls - setfsgid03_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setfsgid03_16"
        rlRun "kirk -f syscalls -p setfsgid03_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setfsgid03_16"
