#!/bin/bash
# Functional test: ltp - syscalls - gethostname01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - gethostname01"
        rlRun "kirk -f syscalls -p gethostname01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP gethostname01"
