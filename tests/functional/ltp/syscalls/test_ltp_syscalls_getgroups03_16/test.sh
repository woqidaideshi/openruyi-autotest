#!/bin/bash
# Functional test: ltp - syscalls - getgroups03_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getgroups03_16"
        rlRun "kirk -f syscalls -p getgroups03_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getgroups03_16"
