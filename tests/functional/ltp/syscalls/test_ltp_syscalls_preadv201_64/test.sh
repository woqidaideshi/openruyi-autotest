#!/bin/bash
# Functional test: ltp - syscalls - preadv201_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - preadv201_64"
        rlRun "kirk -f syscalls -p preadv201_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP preadv201_64"
