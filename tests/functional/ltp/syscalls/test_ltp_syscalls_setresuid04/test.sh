#!/bin/bash
# Functional test: ltp - syscalls - setresuid04
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setresuid04"
        rlRun "kirk -f syscalls -p setresuid04 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setresuid04"
