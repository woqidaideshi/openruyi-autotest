#!/bin/bash
# Functional test: ltp - syscalls - chown01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - chown01_16"
        rlRun "kirk -f syscalls -p chown01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP chown01_16"
