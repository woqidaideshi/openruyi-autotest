#!/bin/bash
# Functional test: ltp - syscalls - fstatfs02_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fstatfs02_64"
        rlRun "kirk -f syscalls -p fstatfs02_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fstatfs02_64"
