#!/bin/bash
# Functional test: ltp - syscalls - setgroups02_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setgroups02_16"
        rlRun "kirk -f syscalls -p setgroups02_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setgroups02_16"
