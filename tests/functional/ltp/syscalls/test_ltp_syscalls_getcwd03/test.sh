#!/bin/bash
# Functional test: ltp - syscalls - getcwd03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getcwd03"
        rlRun "kirk -f syscalls -p getcwd03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getcwd03"
