#!/bin/bash
# Functional test: ltp - syscalls - ftruncate03_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - ftruncate03_64"
        rlRun "kirk -f syscalls -p ftruncate03_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP ftruncate03_64"
