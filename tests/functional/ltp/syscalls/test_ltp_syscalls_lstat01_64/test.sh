#!/bin/bash
# Functional test: ltp - syscalls - lstat01_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - lstat01_64"
        rlRun "kirk -f syscalls -p lstat01_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP lstat01_64"
