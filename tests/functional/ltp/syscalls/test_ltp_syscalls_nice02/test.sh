#!/bin/bash
# Functional test: ltp - syscalls - nice02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - nice02"
        rlRun "kirk -f syscalls -p nice02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP nice02"
