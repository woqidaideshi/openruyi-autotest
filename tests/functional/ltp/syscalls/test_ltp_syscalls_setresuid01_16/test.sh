#!/bin/bash
# Functional test: ltp - syscalls - setresuid01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setresuid01_16"
        rlRun "kirk -f syscalls -p setresuid01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setresuid01_16"
