#!/bin/bash
# Functional test: ltp - syscalls - getresuid01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getresuid01_16"
        rlRun "kirk -f syscalls -p getresuid01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getresuid01_16"
