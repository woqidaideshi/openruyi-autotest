#!/bin/bash
# Functional test: ltp - syscalls - getgid01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getgid01_16"
        rlRun "kirk -f syscalls -p getgid01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getgid01_16"
