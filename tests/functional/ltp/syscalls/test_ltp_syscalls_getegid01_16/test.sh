#!/bin/bash
# Functional test: ltp - syscalls - getegid01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getegid01_16"
        rlRun "kirk -f syscalls -p getegid01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getegid01_16"
