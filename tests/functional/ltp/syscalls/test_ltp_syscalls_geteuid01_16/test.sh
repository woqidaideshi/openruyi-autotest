#!/bin/bash
# Functional test: ltp - syscalls - geteuid01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - geteuid01_16"
        rlRun "kirk -f syscalls -p geteuid01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP geteuid01_16"
