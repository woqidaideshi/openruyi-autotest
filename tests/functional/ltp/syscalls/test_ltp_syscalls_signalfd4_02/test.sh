#!/bin/bash
# Functional test: ltp - syscalls - signalfd4_02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - signalfd4_02"
        rlRun "kirk -f syscalls -p signalfd4_02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP signalfd4_02"
