#!/bin/bash
# Functional test: ltp - syscalls - fchown01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fchown01_16"
        rlRun "kirk -f syscalls -p fchown01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fchown01_16"
