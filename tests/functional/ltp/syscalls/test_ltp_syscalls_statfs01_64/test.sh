#!/bin/bash
# Functional test: ltp - syscalls - statfs01_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - statfs01_64"
        rlRun "kirk -f syscalls -p statfs01_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP statfs01_64"
