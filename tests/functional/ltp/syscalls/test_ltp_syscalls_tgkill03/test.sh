#!/bin/bash
# Functional test: ltp - syscalls - tgkill03
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - tgkill03"
        rlRun "kirk -f syscalls -p tgkill03 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP tgkill03"
