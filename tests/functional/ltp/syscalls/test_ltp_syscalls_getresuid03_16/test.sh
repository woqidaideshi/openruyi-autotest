#!/bin/bash
# Functional test: ltp - syscalls - getresuid03_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getresuid03_16"
        rlRun "kirk -f syscalls -p getresuid03_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getresuid03_16"
