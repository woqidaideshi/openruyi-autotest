#!/bin/bash
# Functional test: ltp - syscalls - getegid02_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getegid02_16"
        rlRun "kirk -f syscalls -p getegid02_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getegid02_16"
