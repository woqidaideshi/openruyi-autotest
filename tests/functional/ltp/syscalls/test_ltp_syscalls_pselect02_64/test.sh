#!/bin/bash
# Functional test: ltp - syscalls - pselect02_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - pselect02_64"
        rlRun "kirk -f syscalls -p pselect02_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP pselect02_64"
