#!/bin/bash
# Functional test: ltp - syscalls - getresuid02_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - getresuid02_16"
        rlRun "kirk -f syscalls -p getresuid02_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP getresuid02_16"
