#!/bin/bash
# Functional test: ltp - syscalls - setitimer02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setitimer02"
        rlRun "kirk -f syscalls -p setitimer02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setitimer02"
