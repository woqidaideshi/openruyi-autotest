#!/bin/bash
# Functional test: ltp - syscalls - fcntl25_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - fcntl25_64"
        rlRun "kirk -f syscalls -p fcntl25_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP fcntl25_64"
