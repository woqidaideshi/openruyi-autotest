#!/bin/bash
# Functional test: ltp - syscalls - eventfd2_02
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - eventfd2_02"
        rlRun "kirk -f syscalls -p eventfd2_02 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP eventfd2_02"
