#!/bin/bash
# Functional test: ltp - syscalls - preadv02_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - preadv02_64"
        rlRun "kirk -f syscalls -p preadv02_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP preadv02_64"
