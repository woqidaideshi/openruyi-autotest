#!/bin/bash
# Functional test: ltp - syscalls - setfsuid01_16
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - setfsuid01_16"
        rlRun "kirk -f syscalls -p setfsuid01_16 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP setfsuid01_16"
