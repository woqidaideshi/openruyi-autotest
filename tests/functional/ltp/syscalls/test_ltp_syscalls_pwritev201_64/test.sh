#!/bin/bash
# Functional test: ltp - syscalls - pwritev201_64
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - pwritev201_64"
        rlRun "kirk -f syscalls -p pwritev201_64 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP pwritev201_64"
