#!/bin/bash
# Functional test: ltp - syscalls - futimesat01
...
rlJournalStart
    ...
    rlPhaseStartTest "LTP syscalls - futimesat01"
        rlRun "kirk -f syscalls -p futimesat01 2>&1 | tee /tmp/ltp_out_$$; exit ${PIPESTATUS[0]}" 0 "执行 LTP futimesat01"
