#!/bin/bash
# Functional test: libomp22-devel - cmake export integrity verification
...
project(cmake_module_verify
  VERSION "0.1"
  LANGUAGES C)
list(APPEND CMAKE_MODULE_PATH "/usr/lib64/llvm22/lib/riscv64-openruyi-linux/cmake/openmp")
