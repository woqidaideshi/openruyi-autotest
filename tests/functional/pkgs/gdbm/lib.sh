...
gdbmSetup() {
 ...
 rlLogInfo "already gdbm soft ()"

 else

 echo "installed=0" > "$PKG_FLAG"

 rlLogInfo "gdbm softalready exists"
 ...
 rlLogInfo "gdbm alreadybyothertest, reference count: $ref"
...
gdbmCleanup() {
 ...
 rlLogInfo "already gdbm soft (posttest)"
 ...
 rlLogInfo "gdbm Retain (still have $ref test(s) not completed)"
