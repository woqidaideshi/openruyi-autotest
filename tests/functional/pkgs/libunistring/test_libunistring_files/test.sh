...
rlJournalStart
    ...
    rlPhaseStartTest "�ļ���֤"
        ...
        rlRun "pkg-config --libs libunistring 2>&1 | grep -qiE \"error|Error|not found|No such|无法\" || echo expected-error" 1 "pkg-config ����Ϣ"
    rlPhaseEnd
    ...
    rlPhaseStartCleanup "清理测试环境"
        ...
        # libunistring 软件包由 lib.sh 的引用计数机制自动管理卸载
    rlPhaseEnd
