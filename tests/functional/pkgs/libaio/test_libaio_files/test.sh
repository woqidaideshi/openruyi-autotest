...
rlJournalStart
 ...
 rlRun "pkg-config --libs libaio 2>&1 | grep -qiE \"error|Error|not found|No such|Unable to\" || echo expected-error" 1 "pkg-config Ϣ"
 rlPhaseEnd
 ...
 # libaio Package managed by lib.sh 's reference counting auto-uninstall
 rlPhaseEnd
