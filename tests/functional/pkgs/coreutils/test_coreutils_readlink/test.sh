#!/bin/bash
# Functional test: coreutils - readlink resolve symlinks
...
rlJournalStart
    ...
    rlPhaseStartTest "readlink resolve symlinks"
    rlRun "ln -sf file1.txt readlink_test.txt" 0 "Create symlink"
    rlRun "readlink readlink_test.txt" 0 "readlink resolve symlink"
    rlPhaseEnd
