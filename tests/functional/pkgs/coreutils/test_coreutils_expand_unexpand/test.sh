#!/bin/bash
# Functional test: coreutils - expand/unexpand tabs
...
rlJournalStart
    ...
    rlPhaseStartTest "expand/unexpand tabs"
    rlRun "echo -e 'a\tb' | expand" 0 "expand tabs to spaces"
    rlRun "echo 'a        b' | unexpand -a" 0 "unexpand -a spaces to tabs"
    rlPhaseEnd
