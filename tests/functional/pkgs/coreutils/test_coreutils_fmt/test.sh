#!/bin/bash
# Functional test: coreutils - fmt format text
...
rlJournalStart
    ...
    rlPhaseStartTest "fmt format text"
    rlRun "echo 'This is a long line of text that should be reformatted by fmt' > fmt_test.txt" 0 "Create fmt test file"
    rlRun "fmt fmt_test.txt" 0 "fmt format text"
    rlPhaseEnd
