...
rlJournalStart
    ...
    rlPhaseStartTest "�ļ���֤"
        ...
        rlRun "pkg-config --libs libnfnetlink 2>&1 | grep -qiE \"error|Error|not found|No such|无法\" || echo expected-error" 1 "pkg-config ����Ϣ"
    rlPhaseEnd
    ...
    rlPhaseStartCleanup "清理测试环境"
        ...
        # libnfnetlink 软件包由 lib.sh 的引用计数机制自动管理卸载
    rlPhaseEnd
