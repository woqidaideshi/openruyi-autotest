...
rlJournalStart
 ...
 rlRun "echo \"test data for bzip2\" > testfile" 0 "error handling���ļ�"
 rlRun "bzip2 -k testfile" 0 "ѹ���ļ�(����ԭ�ļ�)"
 rlRun "test -f testfile.bz2" 0 "��֤ѹ���fileattribute"
 rlRun "bunzip2 -k testfile.bz2" 0 "��ѹ�ļ�(����ѹ���ļ�)"
 rlRun "bzip2 testfile" 0 "ѹ���ļ�(ɾ��ԭ�ļ�)"
 rlRun "test -f testfile.bz2" 0 "��֤ѹ���fileattribute"
 rlRun "bunzip2 testfile.bz2" 0 "��ѹ�ļ�"
 rlRun "test -f testfile" 0 "��֤��ѹ���fileattribute"
 rlRun "echo \"hello bzip2\" | bzip2 > test2.bz2" 0 "ͨ���ܵ�ѹ��"
 rlRun "bzcat test2.bz2" 0 "�ѹ���fileattribute"
 rlPhaseEnd
