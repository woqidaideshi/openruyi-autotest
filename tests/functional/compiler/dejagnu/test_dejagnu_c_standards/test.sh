#!/bin/bash
# Functional test: compiler - dejagnu - C 语言标准 (C99/C11/C17)
...
CEOF
    ...
    rlPhaseStartTest "Clang C 标准"
        ...
        diff -q /tmp/c99_gcc.txt /tmp/c99_clang.txt >/dev/null 2>&1 && rlPass "C99 GCC/Clang 输出一致" || rlLogInfo "C99 输出有差异"
    rlPhaseEnd
