#!/bin/bash
# jotai - floating-point: -ffast-math, -fno-fast-math, NaN/Inf handle
...
CEOF
 ...
 rlPhaseStartTest "GCC floating-point"
 ...
 rlPhaseStartTest "Clang floating-point"
 rlRun "clang -o fp_clang fp.c -lm &&./fp_clang | grep FP_OK" 0 "Clang floating-point OK"
