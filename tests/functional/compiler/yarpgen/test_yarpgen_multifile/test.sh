#!/bin/bash
# Functional test: compiler - yarpgen - 多文件分离编译 + C/C++ 混合
...
CEOF
    ...
    rlPhaseStartTest "GCC/G++ 分离编译"
        rlRun "gcc -c str.c -o str.o && gcc -c mat.c -o mat.o" 0 "GCC 编译 .o"
        rlRun "g++ -o multi_gxx main.cpp str.o mat.o && ./multi_gxx | grep MULTI_OK" 0 "G++ 链接 C+C++"
    rlPhaseEnd

    rlPhaseStartTest "Clang/Clang++ 分离编译"
        rlRun "clang -c str.c -o str_c.o && clang -c mat.c -o mat_c.o" 0 "Clang 编译 .o"
        rlRun "clang++ -o multi_clang main.cpp str_c.o mat_c.o && ./multi_clang | grep MULTI_OK" 0 "Clang++ 链接"
    rlPhaseEnd
