...
rlJournalStart
    ...
    rlPhaseStartTest "MMTests - network_netperf_stream_ipv4_unbound"
    rlRun "_mmtestsRunCase config-network-netperf-stream-ipv4-unbound" 0 "Execute MMTests config-network-netperf-stream-ipv4-unbound"
    rlPhaseEnd
