...
rlJournalStart
 ...
 rlPhaseStartTest "MMTests - network_netperf_rr_ipv6_unbound"
 rlRun "_mmtestsRunCase config-network-netperf-rr-ipv6-unbound" 0 "Execute MMTests config-network-netperf-rr-ipv6-unbound"
 rlPhaseEnd
