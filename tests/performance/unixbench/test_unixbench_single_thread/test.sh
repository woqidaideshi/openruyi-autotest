#!/bin/bash
# Performance test: UnixBench - UnixBench singlethreadbenchmark (-c 1)
...
rlJournalStart
    ...
    rlPhaseStartTest "UnixBench singlethreadbenchmark (-c 1, 3independent runs)"
    ...
    rlLogInfo "singlethread 3 avg of runs System Benchmarks Index Score: $AVG"
    rlPhaseEnd
