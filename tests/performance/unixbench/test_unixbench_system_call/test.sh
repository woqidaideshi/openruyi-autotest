#!/bin/bash
# Performance test: UnixBench - UnixBench system callsoverhead (syscall)
...
rlJournalStart
 ...
 rlPhaseStartTest "UnixBench system callsoverhead (syscall, 3independent runs)"
 ...
 rlLogInfo "system calls 3 avg of runs System Benchmarks Index Score: $AVG"
 rlPhaseEnd
