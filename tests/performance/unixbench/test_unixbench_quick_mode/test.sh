#!/bin/bash
# Performance test: UnixBench - UnixBench quick mode (singlethreadcoresubitems)
...
rlJournalStart
 ...
 rlPhaseStartTest "UnixBench quick mode (singlethreadcoresubitems, 3independent runs)"
 ...
 rlLogInfo "quick mode 3 avg of runs System Benchmarks Index Score: $AVG"
 rlPhaseEnd
